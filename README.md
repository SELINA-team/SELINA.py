...
```
#mtx
selina preprocess --format mtx --matrix ./query/matrix.mtx --feature ./query/features.tsv --barcode ./query/barcodes.tsv   --directory ./res/preprocess/

#h5
selina preprocess --format h5 --matrix ./query/query_gene_count.h5 --directory ./res/preprocess/

#plain
selina preprocess --format plain --matrix ./query/query.txt --directory ./res/preprocess/
```
...
Running this command will output eight files:
